...
public class JadeInterPlatformSendAgent extends Agent {
    ...
    protected void setup() {
		...
		int x = Integer.parseInt(temp.getContent());
 		...
 		AID remoteAMS = new AID("jaap@192.168.0.13:1100/JADE", AID.ISGUID);
                remoteAMS.addAddresses("http://agilemanufacturing-equiplet1-visioncore:33488/acc");
