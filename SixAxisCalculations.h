...
class SixAxisCalculations {
    ...
    public:
        ...
        //74.396 == magic number
        static const double MOTOR_A_POS_ON_CIRCLE = 0;
        static const double MOTOR_A1_POS_ON_CIRCLE = 0 - 37.198;
        static const double MOTOR_A2_POS_ON_CIRCLE = 0 + 37.198;
  
        static const double MOTOR_B_POS_ON_CIRCLE = 120;
        static const double MOTOR_B1_POS_ON_CIRCLE = 120 - 37.198;
        static const double MOTOR_B2_POS_ON_CIRCLE = 120 + 37.198;
  
        static const double MOTOR_C_POS_ON_CIRCLE = 240;
        static const double MOTOR_C1_POS_ON_CIRCLE = 240 - 37.198;
        static const double MOTOR_C2_POS_ON_CIRCLE = 240 + 37.198;
