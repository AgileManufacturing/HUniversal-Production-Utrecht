...
double * SixAxisCalculations::getAngles(double angles[6], Point3D moveTo, double xRotation, double yRotation, double zRotation){
    ...
    angles[4] = getAngleForMotor(moveTo, SixAxisCalculations::MOTOR_C_POS_ON_CIRCLE, SixAxisCalculations::MOTOR_C1_POS_ON_CIRCLE, xRotation, yRotation, zRotation);
    angles[5] = getAngleForMotor(moveTo, SixAxisCalculations::MOTOR_C_POS_ON_CIRCLE, SixAxisCalculations::MOTOR_C2_POS_ON_CIRCLE, xRotation, yRotation, zRotation);
