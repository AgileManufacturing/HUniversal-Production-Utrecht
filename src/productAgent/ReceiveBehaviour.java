...
/**
 * @author Alexander Receiver class based on the ReceiverBehaviour. instead of
 *         polling .done(), this class will return when either the timeout fires
 *         or a msg is received.
 */
