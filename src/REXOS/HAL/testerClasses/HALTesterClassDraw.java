...
public class HALTesterClassDraw implements HardwareAbstractionLayerListener {
	...
	public static void main(String[] args) throws Exception {
		...
		File workplaneJar = new File(baseDir + "Workplane.jar");
		fis = new FileInputStream(workplaneJar);
		content = new byte[(int) workplaneJar.length()];
		fis.read(content);
		fis.close();
		String base64Workplane = new String(Base64.encodeBase64(content));
...
//		
		// workplane
		String moduleE = moduleE_01 + base64WorkplaneRos + moduleE_02 + base64Workplane + moduleE_03;
		...
		hal.deleteModule(new ModuleIdentifier("HU", "workplane_type_A", "1"));
