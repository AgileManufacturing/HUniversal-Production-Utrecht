...
public class ServerConfigurations {
	...
	public static final String GS_IP = "145.89.126.250";
	public static final String GS_PORT = "1099";
	public static final String AGENT_ADDRESS = "145.89.126.250"+":"+GS_PORT+"/JADE";
	public static final String GS_NAME = "Grid@"+AGENT_ADDRESS;
	public static final String GS_ADDRESS = "http://145.89.126.250:1099";
}
