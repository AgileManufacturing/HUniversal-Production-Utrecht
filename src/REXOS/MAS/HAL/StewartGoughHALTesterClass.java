...
public class StewartGoughHALTesterClass implements HardwareAbstractionLayerListener {
	...
	public static void main(String[] args) throws Exception {
		...
		File stewartGoughJar = new File("C:/Users/Aristides/Desktop/StewartGough.jar");
		...
		File stewartGoughZip = new File("C:/Users/Aristides/Desktop/nodes.zip");
		...
		File cameraZip = new File("C:/Users/Aristides/Desktop/nodes.zip");
		...
		File penJar = new File("C:/Users/Aristides/Desktop/Pen.jar");
		...
		File pickAndPlaceJar = new File("C:/Users/Aristides/Desktop/Draw.jar");
		...
		System.out.println("Inserted moduleA");
		// pen
		...
		System.out.println("Inserted moduleB");
		// camera
		...
		System.out.println("Inserted moduleC");
		// lens
		...
		System.out.println("Inserted moduleD");
		...
		targetMove.addProperty("z", -450.0);
