...
public class StewartGoughHALTesterClass implements HardwareAbstractionLayerListener {
	...
	public static void main(String[] args) throws Exception {
		...
		File stewartGoughJar = new File("/home/t/Desktop/DeltaRobot.jar");
		...
		File stewartGoughJarZip = new File("/home/t/Desktop/nodes.zip");
		fis = new FileInputStream(stewartGoughJarZip);
		content = new byte[(int) stewartGoughJarZip.length()];
		fis.read(content);
		fis.close();
